# Generated by Django 5.1.1 on 2025-02-11 05:01
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('default_section', models.CharField(choices=[('A', 'A'), ('B', 'B'), ('C', 'C'), ('D', 'D'), ('E', 'E'), ('F', 'F')], default='A', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rollno', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Projects', to='flexapp.student')),
            ],
        ),
        migrations.CreateModel(
            name='LeetCode',
            fields=[
                ...
                ('rollno', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='studentrollno', to='flexapp.student')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rollno', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ForeignLanguages', to='flexapp.student')),
            ],
        ),
    ]
